...
<head>
    ...
    <style>
        #alert-container {
            ...
            width: 50%; /* Set the width of the alert box */
        ...
        .alert {
            ...
            max-width: 100%; /* Ensure the alert box doesn't exceed container width */
        }
    </style>
</head>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status === 'success') {
                        alertBox = `<div class="col-sm-12"> <!-- Adjusted to col-sm-12 for a larger width -->
                ...
                error: function () {
                    const alertBox = `<div class="col-sm-12"> <!-- Adjusted to col-sm-12 for a larger width -->
                                        <div class="alert alert-danger alert-dismissible fade show px-4 mb-0 text-center" role="alert">
                                            <i class="mdi mdi-block-helper d-block display-4 mt-2 mb-3 text-danger"></i>
                                            <h5 class="text-danger">Error</h5>
